...
TARGET = bootloaderCAN

OBJDIR = BootloaderCAN

# List C source files here. (C dependencies are automatically generated.)
SRC = $(TARGET).c at90can_get_message.c at90can_send_message.c at90can.c
...
AVRDUDE_WRITE_FUSES = -Ulfuse:w:0xff:m -Uhfuse:w:0xd0:m -Uefuse:w:0xfb:m 
...
AVRDUDE_FLAGS = -p $(MCU) -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER) -B15
...
ELFSIZE = $(SIZE) --format=avr --mcu=$(MCU) $(OBJDIR)/$(TARGET).elf
sizebefore:
